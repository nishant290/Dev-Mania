  ...
  return (
    <>
      ...
      <div className="box flex">
        <div className="post-content m-8 max-w-3/4  ">
          <div className="post-image object-cover w-fit">
            <img src={post.postImage} />
          </div>
          <div className="hashtags my-8 flex flex-wrap gap-2">
            {post.hashtags?.map((tag, index) => (
              <span key={index} className='inline-flex items-center font-bold border-2 rounded-2xl px-3 py-1.5 text-xs sm:text-sm'>{tag}</span>
            ))}
          </div>
          <div className="title object-contain font-bold text-3xl sm:text-5xl my-8 sm:font-extrabold">
            {post.title}
          </div>
          <div className="content whitespace-pre-wrap break-words text-lg object-contain">
            {post.content}
          </div>
        </div>

        <div className="right-box flex justify-between my-18 mx-6">
          <div className='fixed flex gap-18'>
